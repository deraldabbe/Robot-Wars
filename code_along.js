...
if (roboAttack > robo2Attack){
    console.log('robo has a higher attack then robo2')
} else {
...
console.log(robo2Health)

let attacks = 0

while(roboHealth > 30){
    roboHealth -= robo2Attack - roboDefense
    console.log(`rbo2 attacks robo. his health is now ${roboHealth} after taking 10 damage`)
    attacks++
